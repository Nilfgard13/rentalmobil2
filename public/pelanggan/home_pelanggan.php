    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    <a href="home_pelanggan.php"><i class="fa fa-tachometer"></i> <span class="nav-label">Dashboard</span></a>
                </li>
                <li>
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                    <span class="m-r-sm text-muted welcome-message"><span class="label label-danger">Anda perlu menambahkan KTP</span></span>
                </li>
                <li class="dropdown">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        <li>
                            <a href="home_pelanggan.php">Pelanggan</a>
                        </li>
                        <li class="active">
