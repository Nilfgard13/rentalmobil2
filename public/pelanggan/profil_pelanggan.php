...
require __DIR__ . '/../../src/pelanggan.php';
require_login();
?>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                    ...
                    <div class="dropdown profile-element"> <span>
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"> <span class="block m-t-xs"> <strong
                                ...
                                </span> <span class="text-muted text-xs block">Pelanggan<b class="caret"></b></span>
                            </span> </a>
                ...
                <li>
                    <a href="home_pelanggan.php"><i class="fa fa-tachometer"></i> <span
                ...
                <li class="active">
                    <a href="profil_pelanggan.php"><i class="fa fa-user"></i> <span class="nav-label">Profile</span></a>
                </li>
            </ul>
        ...
        <div class="col-lg-12">
            <div class="contact-box center-version">
                ...
                <a href="profile.html">
                    ...
                    <img alt="../../src/assets/img/image" class="img-circle"
                        src="../../src/assets/img/profile_small.jpg">


                    <h3 class="m-b-xs"><strong><?php echo $_SESSION['username']; ?></strong></h3>
                    ...
                    <address class="m-t-md">
                        ...
                        <abbr title="Phone">P:</abbr> <?php echo $_SESSION['no_telepon']; ?><br><br>
                        <strong>Nomor KTP</strong><br>
                        <?php
                        if ($_SESSION['no_ktp'] == null) {
                            echo 'No KTP Masih Belum terisi';
                        } else {
                            echo $_SESSION['no_ktp'];
                        }
                        ?>
                ...
                <div class="contact-box-footer">
                    <div class="m-t-xs btn-group">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
                            Klik disini untuk menambahkan no KTP
                        </button>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Tambahkan no KTP</h5>
                                    ...
                                    <div class="modal-body">
                                        <input class="form-control" type="text" name="no_ktp" id="no_ktp"
                                            value="<?= $inputs['no_ktp'] ?? '' ?>" placeholder="No KTP" required="">
                                    </div>
