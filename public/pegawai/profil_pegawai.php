    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                    ...
                    <div class="dropdown profile-element"> <span>
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"> <span class="block m-t-xs"> <strong
                                ...
                                </span> <span class="text-muted text-xs block">Pegawai<b class="caret"></b></span>
                            </span> </a>
                ...
                <li>
                    <a href="home_pegawai.php"><i class="fa fa-tachometer"></i> <span
                ...
                <li class="active">
                    <a href="profil_pegawai.php"><i class="fa fa-user"></i> <span class="nav-label">Profil
                            Pegawai</span></a>
                </li>
            </ul>
        ...
        <div class="col-lg-12">
                <div class="contact-box center-version">
                    ...
                    <a href="profile.html">
                        ...
                        <img alt="../../src/assets/img/image" class="img-circle" src="../../src/assets/img/a2.jpg">
