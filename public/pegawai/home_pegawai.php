    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    <a href="home_pegawai.php"><i class="fa fa-tachometer"></i> <span class="nav-label">Dashboard</span></a>
                </li>
                <li>
                ...
                <li>
                    <a href="profil_pegawai.php"><i class="fa fa-user"></i> <span class="nav-label">Profil Pegawai</span></a>
                </li>
            </ul>
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Dashboard Pegawai</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
